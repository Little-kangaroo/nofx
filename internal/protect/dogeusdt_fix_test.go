...
func TestDOGEUSDTStopUpdateFix(t *testing.T) {
	...
	// 验证盈利地板：floor = Entry + R0 * 0.03 = 0.124520 + 0.001720*0.03 = 0.124572
	expectedFloor := 0.124572
	...
	// 验证新止损价格（FloorToTick(0.124572, 0.00001) = 0.124570）
	expectedNewStop := 0.124570
